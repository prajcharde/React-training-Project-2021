...
class GiftsListContainer extends React.Component {
  ...
  fetchMorecards = () =>{
    ...
    this.setState({getRecordNumber : this.state.getRecordNumber + 10}); 
    this.props.fetchCards(previousindex, previousindex+10);
...
const mapStateToProps = state => {
  return {
    ...
    totalCount: state.gifts.totalCount,
